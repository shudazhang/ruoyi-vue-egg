 ...
 class GenConstants
{
    ...
    /** 数据库数字类型 */
     static  COLUMNTYPE_NUMBER = [ "tinyint", "smallint", "mediumint", "int", "number", "integer",
    ...
    /** 页面不需要显示的列表字段 */
     static  COLUMNNAME_NOT_LIST = [ "id", "create_by", "create_time", "del_flag", "update_by",
            "update_time" ];

    /** 页面不需要查询字段 */
     static  COLUMNNAME_NOT_QUERY = [ "id", "create_by", "create_time", "del_flag", "update_by",
            "update_time", "remark" ];

    /** Entity基类字段 */
     static  BASE_ENTITY = [ "createBy", "createTime", "updateBy", "updateTime", "remark" ];

    /** Tree基类字段 */
     static  TREE_ENTITY = [ "parentName", "parentId", "orderNum", "ancestors", "children" ];
